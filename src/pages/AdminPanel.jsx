          ...
          <div className="rounded-lg bg-white p-6 shadow">
            ...
            <div className="mb-4">
              <input
                ...
                placeholder="Search by customer, phone, address, instructions, source, order ID, item, payment..."
                className="w-full rounded-md border border-gray-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
            </div>
                        ...
                        <React.Fragment key={order.orderId}>
                          <tr className="border-b align-top hover:bg-gray-50">
                            ...
                            <td className="px-4 py-3">
                              <span className={`inline-flex rounded-full px-3 py-1 text-xs font-semibold ${order.orderSource === 'external' ? 'bg-orange-100 text-orange-700' : 'bg-slate-100 text-slate-700'}`}>
                                {order.orderSource === 'external' ? 'External' : 'Internal'}
                              </span>
                            </td>
